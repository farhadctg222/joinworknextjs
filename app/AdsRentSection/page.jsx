...
<title><h2 className="text-3xl font-bold text-gray-900">Advertise with Us</h2>
          ...
          <p className="mt-2 text-gray-600">Choose a plan that fits your needs and reach your audience!</p></title>
        </div>
