    ...
    <section className="bg-gray-100 py-12">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center mb-8">
          ...
          <p className="mt-2 text-gray-600"><title>Choose a plan that fits your needs and reach your audience!</title>title></p>
        </div>

        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
          {plans.map((plan, index) => (
            <div key={index} className="bg-white rounded-lg shadow-lg p-6">
              <h3 className="text-xl font-semibold text-gray-900"><title>{plan.name}</title></h3>
              <p className="mt-4 text-2xl font-bold text-gray-800"><title>{plan.price}</title></p>
