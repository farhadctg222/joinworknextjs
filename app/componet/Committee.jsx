        ...
        <div class="py-8 px-4 mx-auto max-w-screen-xl lg:py-16 lg:px-6 ">
            ...
            <div class="grid gap-8 mb-6 lg:mb-16 md:grid-cols-2">
                <div class="items-center bg-gray-50 rounded-lg shadow sm:flex dark:bg-gray-800 dark:border-gray-700">
                    <a href="#">
                    <Image src={pic3} class="w-full rounded-lg sm:rounded-none sm:rounded-l-lg" placeholder="blur" alt="Child Donation" ></Image></a>
                    <div class="p-5">
                ...
                <div class="items-center bg-gray-50 rounded-lg shadow sm:flex dark:bg-gray-800 dark:border-gray-700">
                    <a href="#">
                        <Image src={pic3} class="w-full rounded-lg sm:rounded-none sm:rounded-l-lg" placeholder="blur" alt="Child Donation" ></Image>
                    </a>
                    <div class="p-5">
                        <h3 class="text-xl font-bold tracking-tight text-gray-900 dark:text-white">
                            <a href="#">Jese Leos</a>
